...
const Footer = () =>{
  ...
  <a className="link link-hover">3H, Seibu Tower, 24th Street cor 6th Avenue, <br />   Bonifacio Global City, Taguig City, 1632</a> 
  <a className="link link-hover flex gap-2">
<div className="mt-1">  <BsTelephoneFill  ></BsTelephoneFill></div>
  <a href="">0917 623 0167</a>
  </a> 
  <a className="link link-hover flex gap-2">
  <div className="mt-1">  <BsTelephonePlusFill ></BsTelephonePlusFill></div>
    <a href="">(02) 7504 0568</a>
    </a> 
</div>
</footer> 
<footer className="footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300">
  <div className="items-center grid-flow-col">
    ...
    <p>Talent-Hunt <br/>Providing reliable tech since 2020</p>
  </div> 
