...
const CoreValues = () =>{
    ...
    <div className=' mr-6'><BsFillStarFill size={33}></BsFillStarFill></div>
...
<div className='bg-yellow-400 p-12  mb-10 flex justify-start'>
  ...
  <div className=' mr-6'><FaUserFriends  size={33}></FaUserFriends></div>
  <div>
...
<div className='bg-pink-400 p-12  mb-10  flex justify-start'>
  ...
  <div className=' mr-6' ><FaLock size={33}></FaLock></div>
  <div>
